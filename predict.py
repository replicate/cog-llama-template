...
class Predictor(BasePredictor):
    ...
    def get_lora(self, replicate_weights: str) -> Tuple[str, io.BytesIO]:
        ...
        adapter_model_bytes = io.BytesIO(data["adapter_model.bin"])
        adapter_config_bytes = data["adapter_config.json"]
        return (adapter_config_bytes, adapter_model_bytes)
    ...
    def predict(
        ...
        prompt: str = Input(description="Prompt to send to CodeLlama."),
